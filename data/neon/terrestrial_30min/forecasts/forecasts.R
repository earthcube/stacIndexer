...
reference_datetime <- '2022-05-05 00:00:00'
site_id <- 'BART'
...
build_forecast_scores(table_schema = theme_df,
                      ...
                      destination_path = "stac/phenology/forecasts/",
                      description_path = 'stac/aquatics/phenology/asset-description.Rmd',
                      aws_download_path = 'neon4cast-scores/forecasts/phenology')
