...
for (m in theme_models$model.id[1:2]){
  ...
  if (m %in% neon_docs$model.id){
    ...
    build_model(model_id = neon_docs$model.id[idx],
                ...
                destination_path = "stac/phenology/forecasts/models",
                description_path = "stac/phenology/forecasts/models/asset-description.Rmd",
                aws_download_path = 'neon4cast-forecasts/parquet/phenology',
    ...
    build_model(model_id = m,
                ...
                model_documentation = neon_docs,
                destination_path = "stac/phenology/forecasts/models",
                description_path = "stac/phenology/forecasts/asset-description.Rmd",
                aws_download_path = 'neon4cast-forecasts/parquet/phenology',
                theme_title = "Forecasts",
                collection_name = 'forecasts',
                thumbnail_image_name = 'latest_forecast.png',
...
write.csv(forecast_sites_df, 'stac/phenology/forecasts/all_forecast_sites.csv', row.names = FALSE)
