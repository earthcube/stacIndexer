...
build_forecast_scores(table_schema = theme_df,
                      ...
                      destination_path = "stac/beetles/scores/",
                      description_path = 'stac/beetles/scores/asset-description.Rmd',
