...
- **Status:** ❌ **INVALID**
- **Generated:** 2026-08-22T00:14:41.286451
...
## Issues (11 distinct, 21 errors)

| # | Scope | Issue | Errors |
| ---: | --- | --- | ---: |
| 1 | **Catalog** ⚠️ | Catalog children could not be read | 1 |
| 2 | **Catalog** ⚠️ | Catalog children could not be read | 1 |
| 3 | **Collection** ⚠️ | Collection is being checked against an Item-only schema | 3 |
...
- **Objects:** [`inventory`](https://raw.githubusercontent.com/eco4cast/usgsrc4cast-ci/main/catalog/inventory/collection.json), [`targets`](https://raw.githubusercontent.com/eco4cast/usgsrc4cast-ci/main/catalog/targets/collection.json), [`sites`](https://raw.githubusercontent.com/eco4cast/usgsrc4cast-ci/main/catalog/sites/collection.json)
...
<details><summary>All 3 raw errors</summary>
...
```
Collection 'targets' validation failed: Validation failed for Collection at https://raw.githubusercontent.com/eco4cast/usgsrc4cast-ci/main/catalog/targets/collection.json with ID targets against schema at https://stac-extensions.github.io/scientific/v1.0.0/schema.json
'Feature' was expected
...
```
Failed to get items for collection 'daily-scores': HREF: 'https://raw.githubusercontent.com/eco4cast/neon4cast-catalog/main/scores/Aquatics/Daily_Dissolved_oxygen/models/LSAMP_AWPC.json' does not resolve to a STAC object
```
